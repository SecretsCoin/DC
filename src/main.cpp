...
unsigned int nStakeMinAge = 60 * 60 * 24 * 1;   // minimum age for coin age: 3d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30; // stake age of full weight: 100d
unsigned int nStakeTargetSpacing = 60;          // 15 sec block spacing

int64 nChainStartTime = 1454396400;
...
const string strMessageMagic = "Digitalasset Signed Message:\n";
...
{
    int64 nSubsidy = 10.0 * COIN;

    if(nHeight == 1)
    {
        nSubsidy = 93000000 * COIN;	
...
static const int64 nTargetSpacingWorkMax = 6 * nStakeTargetSpacing; 
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Digitalasset
    bool fStrictPayToScriptHash = true; // Always active in Digitalasset
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Digitalasset", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Digital asset";
        CTransaction txNew;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xbe30abb45cf1a6dbd975a56c4ae5cd759c2622dd62df96e07cb6cae03c8a3f2d"));

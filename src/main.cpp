...
int64 nChainStartTime = 1454211000;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x2e34a79811fb230fac694def1c0c1d731f67ca0903d365098aa33290b3885d46"));

#############################################################################
# Makefile for building: Digitalasset-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 1? 31 17:42:02 2016
# Project:  yellowcoin-qt.pro
# Template: app
# Command: c:\QT\4.8.6\bin\qmake.exe USE_UPNP=- USE_QRCODE=1 -o Makefile yellowcoin-qt.pro
#############################################################################
...
Makefile: yellowcoin-qt.pro  c:/QT/4.8.6/mkspecs/default/qmake.conf c:/QT/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile yellowcoin-qt.pro
